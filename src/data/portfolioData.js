export const portfolioData = {
  personal: {
    ...
    bio: "Passionate Computer Engineer.",
  },
  ...
  projects: [
    ...
    },
    {
      ...
      githubUrl: "https://github.com/nehlr",
      liveUrl: "https://example.com",
      stars: 76,
      featured: false,
      demoType: "kanban",
  ...
  experiences: [
    ...
    },
    {
      ...
      description: "Co-authored scientific research presented at SIU 2026 (Signal Processing and Communications Applications Congress) focusing on data visualization.",
      technologies: ["Data Visualization", "Signal Processing", "Data Analytics", "Scientific Research"],
      achievements: [
  ...
  terminalCommands: {
    ...
    skills: "React, TypeScript, Python, OpenCV, RAG, Node.js, PostgreSQL, Microsoft Foundry Local, Figma.",
    ...
    contact: "Email: nehir.karamese@example.com | GitHub: github.com | LinkedIn: linkedin.com/in/nehir-karamese",
    "sudo hire": "🎉 High Five! Let's build something extraordinary together. Reach out via LinkedIn or email!"
  }
};
